  ...
  <div class="clearfix"></div>
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>New Third Level Sub-Category</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ route('admin.add_third_level_sub_category') }}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                @method('PUT')
                @csrf
